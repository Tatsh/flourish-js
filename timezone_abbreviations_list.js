// TODO Find way to optimise this to make it smaller or find a way the browser can help to do this better
/**
...
var timezone_abbreviations_list = function () {
  ...
  var j, list = {}, tzo, jlen, timezone_id, dst, indice, curr, currSub, currSubPrefix;
  for (var i = 0, len = php_js_shared.tz_abbrs.length; i < len; i++) {
